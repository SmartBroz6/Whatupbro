...
function updateDisplay() {
    ...
    backgroundImage.src = '/assets/image/bs/im.jpg';
    backgroundImage.onload = function() {
        ...
        drawText(ctx, `${money98}`, 700,703,40,'SFThonburiRegular', '#000000', 'right', 40, 3, 0, 0, 800, 0);
        drawText(ctx, `$${u98}`, 700,742,25,'SFThonburiRegular', '#979a9c', 'right', 40, 3, 0, 0, 800, 0);
        drawText(ctx, `${money99}`, 700,935,40,'SFThonburiRegular', '#000000', 'right', 40, 3, 0, 0, 800, 0);
        drawText(ctx, `$${u99}`, 700,974,25,'SFThonburiRegular', '#979a9c', 'right', 40, 3, 0, 0, 800, 0);
